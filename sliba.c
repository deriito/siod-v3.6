...
LISP err_wta_str(LISP exp) { return (err("not a string", exp)); }
...
LISP llength(LISP obj) { return (flocons(nlength(obj))); }
...
LISP lstrcmp(LISP s1, LISP s2) { return (flocons(strcmp(get_c_string(s1), get_c_string(s2)))); }
...
LISP stringp(LISP x) { return (TYPEP(x, tc_string) ? sym_t : NIL); }
...
LISP writes(LISP args) { return (writes1(get_c_file(car(args), stdout), cdr(args))); }
...
LISP lexp(LISP x) { return (flocons(exp(get_c_double(x)))); }

LISP llog(LISP x) { return (flocons(log(get_c_double(x)))); }

LISP lsin(LISP x) { return (flocons(sin(get_c_double(x)))); }

LISP lcos(LISP x) { return (flocons(cos(get_c_double(x)))); }

LISP ltan(LISP x) { return (flocons(tan(get_c_double(x)))); }

LISP lasin(LISP x) { return (flocons(asin(get_c_double(x)))); }

LISP lacos(LISP x) { return (flocons(acos(get_c_double(x)))); }

LISP latan(LISP x) { return (flocons(atan(get_c_double(x)))); }

LISP latan2(LISP x, LISP y) { return (flocons(atan2(get_c_double(x), get_c_double(y)))); }
...
LISP putprop(LISP plist, LISP value, LISP key) { return (setprop(plist, key, value)); }
...
LISP lstrspn(LISP str1, LISP str2) { return (flocons(strspn(get_c_string(str1), get_c_string(str2)))); }

LISP lstrcspn(LISP str1, LISP str2) { return (flocons(strcspn(get_c_string(str1), get_c_string(str2)))); }
